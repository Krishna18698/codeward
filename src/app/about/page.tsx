...
function SectionEyebrow({ n, label }: { n: string; label: string }) {
  return (
    <p className="mb-4 font-mono text-[11px] uppercase tracking-widest">
  ...
  return (
    <div className="min-h-dvh bg-canvas text-neutral-100">
      ...
      <main className="mx-auto max-w-3xl px-6 pt-40 pb-24">
        {/* Hero */}
        <p className="mb-6 font-mono text-[13px] uppercase tracking-wide text-emerald-400">About</p>
        <h1 className="text-5xl font-semibold tracking-heading leading-[1.05] text-white md:text-6xl">Codeward</h1>
        ...
        <Link
          href="/register"
          className="mt-6 inline-block text-sm font-medium text-emerald-400 transition-colors hover:text-emerald-300"
        >
          Start for free →
        </Link>
        ...
        <div className="mt-28 space-y-24">
          ...
          <section>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-2 border-t border-neutral-800 pt-6 text-sm">
