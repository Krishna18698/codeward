      ...
      <main className="mx-auto max-w-3xl px-6 pt-36 pb-24 text-center">
        ...
        <div className="mt-32 space-y-24">
          <section>
            ...
            <div className="mx-auto mt-6 max-w-xl space-y-4 text-[15px] leading-7 text-neutral-400">
              <p>
            ...
            <div className="mx-auto mt-8 max-w-xl space-y-4">
              {modeList.map(([name, desc]) => (
                <div key={name}>
                  ...
                  <p className="mt-0.5 text-[15px] leading-7 text-neutral-500">{desc}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section>
            ...
            <div className="mx-auto mt-10 flex max-w-xl flex-wrap items-center justify-center gap-x-6 gap-y-2 border-t border-neutral-800 pt-6 text-sm">
