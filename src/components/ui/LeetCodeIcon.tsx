/** LeetCode's mark.
 *
 *  The official single-path logo from simple-icons. What was here before was a
 *  hand-drawn approximation — a diamond outline — which is not LeetCode's mark
 *  and shipped on every problem row.
 */
