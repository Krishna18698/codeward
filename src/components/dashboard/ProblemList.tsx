                              ...
                              <div className="flex items-center gap-1 mr-2">
                                {p.companies.slice(0, 3).map((c) => {
                                  ...
                                  return domain ? (
                                    ...
                                    <img key={c} src={`https://www.google.com/s2/favicons?domain=${domain}&sz=32`} alt={c} title={c} width={15} height={15} className="rounded-sm opacity-70 hover:opacity-100 transition-opacity" />
                                  ) : null;
                                })}
                              </div>
                          ...
                          >
                            ...
                            <div className="flex items-center justify-center gap-1.5">
                              {p.companies.slice(0, 3).map((c) => {
                                ...
                                return domain ? (
                                  // eslint-disable-next-line @next/next/no-img-element
                                  <img key={c} src={`https://www.google.com/s2/favicons?domain=${domain}&sz=32`} alt={c} title={c} width={16} height={16} className="rounded-sm opacity-75 hover:opacity-100 transition-opacity" />
                                ) : null;
                              })}
                            </div>
