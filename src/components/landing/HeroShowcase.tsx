  ...
  return (
    <section className="px-6 pb-10">
      <div className="relative isolate mx-auto max-w-6xl animate-float">
        ...
        <div className="keep-dark-colors overflow-hidden rounded-sm border border-neutral-800 bg-black shadow-[0_40px_120px_-40px_rgba(0,0,0,0.9)]">
          {/* Title bar */}
          ...
          <div className="flex">
            ...
            <aside className="hidden w-48 shrink-0 flex-col border-r border-neutral-800 p-4 md:flex">
              ...
              <div className="mt-8">
                ...
                <p className="mt-1.5 font-mono text-[10px] text-neutral-600">243 of 540 done</p>
              </div>
